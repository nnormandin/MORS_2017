...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{LE_fits <-}\StringTok{ }\KeywordTok{FitMatrix}\NormalTok{(LE_info$preds.matrix, yb$y.vals)}
\NormalTok{MLmetrics::}\KeywordTok{RMSE}\NormalTok{(LE_fits$mean, ytrain)}
\end{Highlighting}
\end{Shaded}
